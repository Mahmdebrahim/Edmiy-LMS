const Testmomials = () => {
  ...
  const renderCard = (testimonial, index) => (
    <div
      key={index}
      className="border border-slate-200 hover:border-slate-300 rounded-xl p-4 shrink-0 w-[350px]"
    >
      ...
      <section className="py-1 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-home-heading-small md:text-4x1 text-gray-800 font-semibold">
